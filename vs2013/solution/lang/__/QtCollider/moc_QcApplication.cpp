...
struct qt_meta_stringdata_QcApplication_t {
    QByteArrayData data[5];
    char stringdata[42];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QcApplication_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QcApplication_t qt_meta_stringdata_QcApplication = {
    {
QT_MOC_LITERAL(0, 0, 13), // "QcApplication"
QT_MOC_LITERAL(1, 14, 9), // "interpret"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 4), // "code"
QT_MOC_LITERAL(4, 30, 11) // "printResult"

    },
    "QcApplication\0interpret\0\0code\0printResult"
};
...
const QMetaObject QcApplication::staticMetaObject = {
    { &QApplication::staticMetaObject, qt_meta_stringdata_QcApplication.data,
      qt_meta_data_QcApplication,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QcApplication::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QcApplication.stringdata))
