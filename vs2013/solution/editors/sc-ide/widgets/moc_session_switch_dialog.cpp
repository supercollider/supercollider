...
struct qt_meta_stringdata_ScIDE__SessionSwitchDialog_t {
    QByteArrayData data[4];
    char stringdata[61];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ScIDE__SessionSwitchDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ScIDE__SessionSwitchDialog_t qt_meta_stringdata_ScIDE__SessionSwitchDialog = {
    {
QT_MOC_LITERAL(0, 0, 26), // "ScIDE::SessionSwitchDialog"
QT_MOC_LITERAL(1, 27, 15), // "onItemActivated"
QT_MOC_LITERAL(2, 43, 0), // ""
QT_MOC_LITERAL(3, 44, 16) // "QListWidgetItem*"

    },
    "ScIDE::SessionSwitchDialog\0onItemActivated\0"
    "\0QListWidgetItem*"
};
...
const QMetaObject ScIDE::SessionSwitchDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ScIDE__SessionSwitchDialog.data,
      qt_meta_data_ScIDE__SessionSwitchDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ScIDE::SessionSwitchDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ScIDE__SessionSwitchDialog.stringdata))
