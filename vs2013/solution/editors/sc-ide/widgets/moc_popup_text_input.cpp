...
struct qt_meta_stringdata_ScIDE__PopupTextInput_t {
    QByteArrayData data[1];
    char stringdata[22];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ScIDE__PopupTextInput_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ScIDE__PopupTextInput_t qt_meta_stringdata_ScIDE__PopupTextInput = {
    {
QT_MOC_LITERAL(0, 0, 21) // "ScIDE::PopupTextInput"

    },
    "ScIDE::PopupTextInput"
};
...
const QMetaObject ScIDE::PopupTextInput::staticMetaObject = {
    { &QInputDialog::staticMetaObject, qt_meta_stringdata_ScIDE__PopupTextInput.data,
      qt_meta_data_ScIDE__PopupTextInput,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ScIDE::PopupTextInput::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ScIDE__PopupTextInput.stringdata))
