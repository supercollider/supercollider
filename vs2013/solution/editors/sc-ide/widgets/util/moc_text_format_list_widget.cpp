...
struct qt_meta_stringdata_ScIDE__TextFormatListWidget_t {
    QByteArrayData data[5];
    char stringdata[59];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ScIDE__TextFormatListWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ScIDE__TextFormatListWidget_t qt_meta_stringdata_ScIDE__TextFormatListWidget = {
    {
QT_MOC_LITERAL(0, 0, 27), // "ScIDE::TextFormatListWidget"
QT_MOC_LITERAL(1, 28, 7), // "clicked"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 5), // "index"
QT_MOC_LITERAL(4, 43, 15) // "onDoubleClicked"

    },
    "ScIDE::TextFormatListWidget\0clicked\0"
    "\0index\0onDoubleClicked"
};
...
void ScIDE::TextFormatListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (TextFormatListWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TextFormatListWidget::clicked)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ScIDE::TextFormatListWidget::staticMetaObject = {
    { &QTreeView::staticMetaObject, qt_meta_stringdata_ScIDE__TextFormatListWidget.data,
      qt_meta_data_ScIDE__TextFormatListWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ScIDE::TextFormatListWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ScIDE__TextFormatListWidget.stringdata))
