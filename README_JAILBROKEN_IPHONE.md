...
2. Install OpenSSH and ldid from Cydia. You probably also want to install SBSettings for a convenient way to among other things switch SSH on and off. It's a must-have app for jailbroken iDevices. You should have SSH turned off at all times except when you need it
...
6. Open the iPhone XCode projects,  in the project and the SuperCollider target settings -> build, set code signing to “Don’t codesign”.
