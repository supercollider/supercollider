...
!function(e, t) {
    ...
    w.fn = w.prototype = {
        ...
        get : function(e) { return null == e ? o.call(this)
        ...
        if ("object" === x(n)) {
            ...
            for (s in n)
                z(e, t, s, n[s], !0, o, a)
                   ...
                   && (i = !0, g(r) || (a = !0),
                       l && (a ? (t.call(e, r), t = null) : (l = t, t = function(e, t, n) { return l.call(w(e), n) })),
                       t))
            for (; s < u; s++)
    ...
    function ce(e) {
        ...
        return i
            || (t = n.body.appendChild(n.createElement(r)), i = w.css(t, "display"), t.parentNode.removeChild(t),
    ...
    function De(e, t, n, r, i, o) {
        ...
        return 1 === o
                   && (a = i,
                       (i = function(e) { return w().off(e), a.apply(this, arguments) }).guid =
            ...
            if (y) {
                n.handler && (n = (o = n).handler, i = o.selector), i && w.find.matchesSelector(be, i),
                    ...
                    (a = y.handle) || (a = y.handle = function(t) {
                        return "undefined" != typeof w && w.event.triggered !== t.type ? w.event.dispatch.apply(
                                   e, arguments)
                                                                                       : void 0
                ...
                while (l--)
                    ...
                    d
                        && (f = w.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d,
                            f = w.event.special[d] || {},
                            c = w.extend({
                                type : d,
                                origType : g,
        ...
        special : {
            ...
            beforeunload : {
                postDispatch : function(
                    e) { void 0 !== e.result && e.originalEvent && (e.originalEvent.returnValue = e.result) }
            }
        }
    },
    ...
    function Re(e, t, n, r) {
        ...
        if (p
            && (i = xe(t, e[0].ownerDocument, !1, e, r), o = i.firstChild, 1 === i.childNodes.length && (i = o),
                o || r)) {
    ...
    function Fe(e, t, n) {
        ...
        return (n = n || $e(e))
                   && ("" !== (a = n.getPropertyValue(t) || n[t]) || w.contains(e.ownerDocument, e)
                           || (a = w.style(e, t)),
                       !h.pixelBoxStyles() && We.test(a) && Be.test(t)
                           && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a,
    ...
    function at() {
        rt
            && (!1 === r.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(at)
    ...
    function ct(e, t, n) {
        ...
        n.queue
            || (null == (a = w._queueHooks(e, "fx")).unqueued
                ...
                a.unqueued++,
                p.always(
                    function() { p.always(function() { a.unqueued--, w.queue(e, "fx").length || a.empty.fire() }) }));
        for (r in t)
            if (i = t[r], it.test(i)) {
    ...
    w.speed =
        ...
        return w.fx.off ? r.duration = 0
                       ...
                       && (r.duration in w.fx.speeds ? r.duration = w.fx.speeds[r.duration]
                          ...
                          r.complete = function() { g(r.old) && r.old.call(this), r.queue && w.dequeue(this, r.queue) },
                          r
    },
    w.fn.extend({
        fadeTo : function(
            e, t, n, r) { return this.filter(ae).css("opacity", 0).show().end().animate({ opacity : t }, e, n, r) },
    ...
    w.fn.extend({
        ...
        toggleClass : function(e, t) {
            ...
            return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e)
    ...
    w.fn.extend({
                    ...
                    return r = g(e), this.each(function(n) {
                        ...
                        1 === this.nodeType
                            && (null == (i = r ? e.call(this, n, w(this).val()) : e) ? i = ""
                                    : "number" == typeof i                           ? i += ""
                                                                                     : Array.isArray(i)
                                        && (i = w.map(i, function(e) { return null == e ? "" : e + "" })),
        ...
        w.each([ "radio", "checkbox" ], function() {
            ...
            h.checkOn
                || (w.valHooks[this].get = function(e) { return null === e.getAttribute("value") ? "on" : e.value })
    ...
    w.extend({
        ...
        ajax : function(t, n) {
            ...
            var i, o, a, s, u, l, c, f, p, d,
                ...
                v = w.Deferred(), m = w.Callbacks("once memory"), x = h.statusCode || {}, b = {}, T = {},
                C = "canceled", E = {
                    readyState : 0,
                    ...
                    setRequestHeader : function(
                        e,
                        t) { return null == c && (e = T[e.toLowerCase()] = T[e.toLowerCase()] || e, b[e] = t), this },
            ...
            (f = w.event && h.global) && 0 == w.active++ && w.event.trigger("ajaxStart"),
                ...
                E.setRequestHeader("Accept",
                                   h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]]
            ...
            function k(t, n, r, s) {
                ...
                c
                    || (c = !0, u && e.clearTimeout(u), i = void 0, a = s || "", E.readyState = t > 0 ? 4 : 0,
                        ...
                        l ? v.resolveWith(g, [ p, C, E ]) : v.rejectWith(g, [ E, C, d ]), E.statusCode(x), x = void 0,
                        f && y.trigger(l ? "ajaxSuccess" : "ajaxError", [ E, h, l ? p : d ]), m.fireWith(g, [ E, C ]),
               ...
               function(e, t) {
                   w[t] = function(e, n, r, i) {
                       return g(n) && (i = i || r, r = n, n = void 0),
                              w.ajax(w.extend({ url : e, type : t, dataType : i, data : n, success : r },
                                              w.isPlainObject(e) && e))
                   }
               }),
        w._evalUrl =
        ...
        w.fn.extend({
            wrapAll : function(e) {
                var t;
                return this[0]
                           && (g(e) && (e = e.call(this[0])), t = w(e, this[0].ownerDocument).eq(0).clone(!0),
        ...
        w.expr.pseudos.visible = function(
            ...
            return {
                send: function(i, o) {
                    ...
                    n =
                        ...
                        return function() {
                            n
                                && (n = r = s.onload = s.onerror = s.onabort = s.ontimeout = s.onreadystatechange =
                                        null,
                                    "abort" === e ? s.abort()
                                        : "error" === e
                    ...
                    void 0 !== s.onabort
                        ...
                        : s.onreadystatechange =
                              function() { 4 === s.readyState && e.setTimeout(function() { n && r() }) },
                    n = n("abort");
                    try {
            ...
            return {
                send: function(i, o) {
                    t = w("<script>")
                            ...
                            .on("load error",
                                n = function(
                                    e) { t.remove(), n = null, e && o("error" === e.type ? 404 : 200, e.type) }),
                            ...
                            if (s || "jsonp" === t.dataTypes[0])
                                return i = t.jsonpCallback = g(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
                                       ...
                                       t.converters["script json"] =
                                           function() { return a || w.error(i + " was not called"), a[0] },
                                       t.dataTypes[0] = "json", o = e[i], e[i] = function() { a = arguments },
                                       r.always(function() {
                                           void 0 === o ? w(e).removeProp(i)
                                                        : e[i] = o,
            ...
            return s > -1 && (r = vt(e.slice(s)), e = e.slice(0, s)),
                   ...
                   a.length > 0
                       && w.ajax({ url : e, type : i || "GET", dataType : "html", data : t })
                              .done(function(
                                  e) { o = arguments, a.html(r ? w("<div>").append(w.parseHTML(e)).find(r) : e) })
                              .always(
                                  n
                                  && function(
                                      e, t) { a.each(function() {
                       ...
                       w.fn[r] = function(i, o) {
                           ...
                           return z(this, function(t, n, i) {
                               ...
                               return y(t) ? 0 === r.indexOf("outer") ? t["inner" + e]
                                   ...
                                   : 9 === t.nodeType
                                   ? (o = t.documentElement,
                                      Math.max(t.body["scroll" + e], o["scroll" + e], t.body["offset" + e],
        ...
        w.proxy =
            ...
            if ("string" == typeof t && (n = e[t], t = e, e = n), g(e))
                return r = o.call(arguments, 2),
                       i = function() { return e.apply(t || this, r.concat(o.call(arguments))) },
