Color {	
	...
	*red { arg val = 1.0, alpha = 1.0; ^Color.new(val, 0.0, 0.0, alpha) }
	*green { arg val = 1.0, alpha = 1.0; ^Color.new(0.0, val, 0.0, alpha) }
	*yellow { arg val = 1.0, alpha = 1.0; ^Color.new(val, val, 0.0, alpha) }
	*blue { arg val = 1.0, alpha = 1.0; ^Color.new(0.0, 0.0, val, alpha) }
