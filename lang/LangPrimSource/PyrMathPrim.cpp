...
void initMathPrimitives()
{
    ...
    definePrimitive(base,
                    index++,
                    "_TGammaDeltaRatio",
                    prBoostTwoArg<double, double, double, boost::math::tgamma_delta_ratio<double>>,
                    2,
                    0);
    ...
    definePrimitive(base,
                    index++,
                    "_GammaPDerivative",
                    prBoostTwoArg<double, double, double, boost::math::gamma_p_derivative<double>>,
                    2,
                    0);
    ...
    definePrimitive(base,
                    index++,
                    "_DoubleFactorial",
                    prBoostOneArg<double, unsigned int, boost::math::double_factorial<double>>,
                    1,
                    0);
    definePrimitive(base,
                    index++,
                    "_RisingFactorial",
                    prBoostTwoArg<double, double, int, boost::math::rising_factorial<double>>,
                    2,
                    0);
    definePrimitive(base,
                    index++,
                    "_FallingFactorial",
                    prBoostTwoArg<double, double, unsigned, boost::math::falling_factorial<double>>,
                    2,
                    0);
    definePrimitive(base,
                    index++,
                    "_BinomialCoefficient",
                    prBoostTwoArg<double, unsigned, unsigned, boost::math::binomial_coefficient<double>>,
                    2,
                    0);
    ...
    definePrimitive(base,
                    index++,
                    "_IBetaInv",
                    prBoostThreeArg<double, double, double, double, boost::math::ibeta_inv<double>>,
                    3,
                    0);
    definePrimitive(base,
                    index++,
                    "_IBetaCInv",
                    prBoostThreeArg<double, double, double, double, boost::math::ibetac_inv<double>>,
                    3,
                    0);
    definePrimitive(base,
                    index++,
                    "_IBetaInvA",
                    prBoostThreeArg<double, double, double, double, boost::math::ibeta_inva<double>>,
                    3,
                    0);
    definePrimitive(base,
                    index++,
                    "_IBetaCInvA",
                    prBoostThreeArg<double, double, double, double, boost::math::ibetac_inva<double>>,
                    3,
                    0);
    definePrimitive(base,
                    index++,
                    "_IBetaInvB",
                    prBoostThreeArg<double, double, double, double, boost::math::ibeta_invb<double>>,
                    3,
                    0);
    definePrimitive(base,
                    index++,
                    "_IBetaCInvB",
                    prBoostThreeArg<double, double, double, double, boost::math::ibetac_invb<double>>,
                    3,
                    0);
    ...
    definePrimitive(base,
                    index++,
                    "_IBetaDerivative",
                    prBoostThreeArg<double, double, double, double, boost::math::ibeta_derivative<double>>,
                    3,
                    0);
    ...
    definePrimitive(base,
                    index++,
                    "_LegendrePPrime",
                    prBoostTwoArg<double, int, double, boost::math::legendre_p_prime<double>>,
                    2,
                    0);
    definePrimitive(base,
                    index++,
                    "_LegendrePZeros",
                    prBoostOneArgRetArray<int, boost::math::legendre_p_zeros<double>>,
                    1,
                    0); // TODO: generalize return array form?
    definePrimitive(base,
                    index++,
                    "_LegendrePAssoc",
                    prBoostThreeArg<double, int, int, double, boost::math::legendre_p<double>>,
                    3,
                    0);
    definePrimitive(
    ...
    definePrimitive(base,
                    index++,
                    "_LaguerreAssoc",
                    prBoostThreeArg<double, unsigned, double, double, boost::math::laguerre<double>>,
                    3,
                    0);
    // Hermite
    definePrimitive(
    ...
    definePrimitive(base,
                    index++,
                    "_SphericalHarmonicR",
                    prBoostFourArg<double, unsigned, int, double, double, boost::math::spherical_harmonic_r<double>>,
                    4,
                    0);
    definePrimitive(base,
                    index++,
                    "_SphericalHarmonicI",
                    prBoostFourArg<double, unsigned, int, double, double, boost::math::spherical_harmonic_i<double>>,
                    4,
                    0);
    ...
    definePrimitive(base,
                    index++,
                    "_CylBesselJZero",
                    prBoostTwoArg<double, double, int, boost::math::cyl_bessel_j_zero<double>>,
                    2,
                    0);
    definePrimitive(base,
                    index++,
                    "_CylNeumannZero",
                    prBoostTwoArg<double, double, int, boost::math::cyl_neumann_zero<double>>,
                    2,
                    0);
    ...
    definePrimitive(base,
                    index++,
                    "_CylBesselJPrime",
                    prBoostTwoArg<double, double, double, boost::math::cyl_bessel_j_prime<double>>,
                    2,
                    0);
    definePrimitive(base,
                    index++,
                    "_CylNeumannPrime",
                    prBoostTwoArg<double, double, double, boost::math::cyl_neumann_prime<double>>,
                    2,
                    0);
    definePrimitive(base,
                    index++,
                    "_CylBesselIPrime",
                    prBoostTwoArg<double, double, double, boost::math::cyl_bessel_i_prime<double>>,
                    2,
                    0);
    definePrimitive(base,
                    index++,
                    "_CylBesselKPrime",
                    prBoostTwoArg<double, double, double, boost::math::cyl_bessel_k_prime<double>>,
                    2,
                    0);
    definePrimitive(base,
                    index++,
                    "_SphBesselPrime",
                    prBoostTwoArg<double, unsigned, double, boost::math::sph_bessel_prime<double>>,
                    2,
                    0);
    definePrimitive(base,
                    index++,
                    "_SphNeumannPrime",
                    prBoostTwoArg<double, unsigned, double, boost::math::sph_neumann_prime<double>>,
                    2,
                    0);
    ...
    definePrimitive(base,
                    index++,
                    "_EllintRf",
                    prBoostThreeArg<double, double, double, double, boost::math::ellint_rf<double>>,
                    3,
                    0);
    definePrimitive(base,
                    index++,
                    "_EllintRd",
                    prBoostThreeArg<double, double, double, double, boost::math::ellint_rd<double>>,
                    3,
                    0);
    definePrimitive(base,
                    index++,
                    "_EllintRj",
                    prBoostFourArg<double, double, double, double, double, boost::math::ellint_rj<double>>,
                    4,
                    0);
    definePrimitive(
    ...
    definePrimitive(base,
                    index++,
                    "_EllintRg",
                    prBoostThreeArg<double, double, double, double, boost::math::ellint_rg<double>>,
                    3,
                    0);
    ...
    definePrimitive(base,
                    index++,
                    "_Ellint3",
                    prBoostThreeArg<double, double, double, double, boost::math::ellint_3<double>>,
                    3,
                    0);
    definePrimitive(
    ...
    definePrimitive(base,
                    index++,
                    "_HeumanLambda",
                    prBoostTwoArg<double, double, double, boost::math::heuman_lambda<double>>,
                    2,
                    0);
