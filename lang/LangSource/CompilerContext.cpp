...
std::ostream& streamSourceCodeWithHighlight(std::ostream& ss, const DiagnosticHighlight& highlight, bool printSource,
                                            const char* newlinePrefixPtr, size_t newlinePrefixSz) {
