if(APPLE)
	...
	if ("${standalone}" STREQUAL "")
		if (SC_IDE)
			...
			set(sclangauxresourcesdir "${scappbundlename}/${scappbundlename}.app/Contents/Resources/sclang.app/Contents/Resources")
			set(sclanginstalldir "${scappbundlename}/${scappbundlename}.app/Contents/Resources/sclang.app/Contents/MacOS")
			set(sclangauxcontents "${scappbundlename}/${scappbundlename}.app/Contents/Resources/sclang.app/Contents/")
		else()
			set(scappbundlename ${PROJECT_NAME}Cocoa)
			set(scappauxresourcesdir  "${scappbundlename}/${scappbundlename}.app/Contents/Resources")
			set(sclangauxresourcesdir "${scappbundlename}/${scappbundlename}.app/Contents/Resources")
			set(sclanginstalldir "${scappbundlename}/${scappbundlename}.app/Contents/Resources")
		endif()
	else()
