...
template <int n>
inline void abs_vec_simd_mp(double * out, const double * src)
{
...
template <int n>
inline void sgn_vec_simd_mp(double * out, const double * src)
{
...
template <int n>
inline void square_vec_simd_mp(double * out, const double * src)
{
...
template <int n>
inline void cube_vec_simd_mp(double * out, const double * src)
{
