...
for being so far behind schedule — this was a really intense release where
determined contributors focused on fixing SC's cross-platform compatibility
demons, plus many, many other horrible bugs that have plagued the project for
years.
