...
- **[Qt][Qt]** >= 5.11 or later. We recommend using the latest version. Use the package `msvc2017_64`
...
Prompt for VS2017** (or VS2019; note that this is not `cmd.exe`), `cd` to the
