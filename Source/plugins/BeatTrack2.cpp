...
float g_sep[8]= {0.0, 0.25, 0.5, 0.75, 0.0, 0.32, 0.5, 0.82};
//weight for particular step
float g_weight[4]= {1.0,0.5,0.9,0.6};
//weight for blurring feature envelope locally
float g_weight2[9]= {0.05, 0.1, 0.3,0.7,1.0,0.7,0.3, 0.1, 0.05};
