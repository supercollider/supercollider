Color {	
	...
	*red { arg val = 1.0, alpha = 1.0; ^Color(val, 0.0, 0.0, alpha) }
	*green { arg val = 1.0, alpha = 1.0; ^Color(0.0, val, 0.0, alpha) }
	*yellow { arg val = 1.0, alpha = 1.0; ^Color(val, val, 0.0, alpha) }
	*blue { arg val = 1.0, alpha = 1.0; ^Color(0.0, 0.0, val, alpha) }
	...
	*rand { arg lo=0.3,hi=0.9; ^Color(rrand(lo,hi),rrand(lo,hi),rrand(lo,hi)) }
	...
	scaleByAlpha {
		^Color(red * alpha, green * alpha, blue * alpha, 1.0)
	}
